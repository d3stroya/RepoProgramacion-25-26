 ...
 * en las que podemos añadir, quitar, modificar elementos durante
 * la ejecución del programa, por tanto su tamaño es dinámico.
 * 
 * Para añdir un elemento, se crea el objeto, se encapsula en un nodo
 * y se crea un puntero desde la lista hacia él.
 * 
 * Las estructuras de datos dinámicas SOLAMENTE trabajan con OBJETOS,
 * NO TRABAJAN CON TIPOS DE DATOS SIMPLES. Por ello, tenemos que conocer
 * un concepto nuevo: la encapsulación.
 * 
 * Las listas son muy eficientes para insertar y eliminar elementos,
 * pero no lo son tanto para acceder a ellos (son más óptimos los arrays).
 * 
 * @author d3stroya
 */
public class Tema09 {
